...
# science fiction
sci_fi_dfm <- dfm_subset(script_dfm, text_type == "scifi")
...
sci_fi_df <- subset(script_df, text_type == "scifi")
...
```{r}
# scientific
sci_fi_kw <- textstat_keyness(script_dfm, docvars(script_dfm, "text_type") == "scifi", measure = "lr")
...
# action
action_kw <- textstat_keyness(script_dfm, docvars(script_dfm, "text_type") == "action", measure = "lr")
...
```{r keynedd between action and thriler}
